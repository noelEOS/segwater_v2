...
OUT = Path.home()/"workspace/results/demak_full_s112_bf16dev_water_area_timeseries.csv"
...
ARMS = ["mx630s2_last_s112_bf16dev"]
EXPECT_ENC = {"mx630s2_last_s112_bf16dev": "tu-swin_base_patch4_window7_224",
              "mx630s2_best": "tu-swin_base_patch4_window7_224",
...
def main():
    ...
    for arm in ARMS:
        ...
        seen[ck] = arm
        assert cfg["inference"]["data"]["stride"] == 112
        scenes = []
